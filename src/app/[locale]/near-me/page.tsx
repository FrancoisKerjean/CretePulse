        ...
        <header className="mb-8">
          ...
          <div className="mt-5 flex flex-wrap gap-2.5">
            <Link
              ...
              className="bg-white border border-border rounded-full px-4 py-2 text-[13px] font-heading font-bold text-sea no-underline hover:bg-surface transition-colors"
            >
              {t.linkSwim}
            </Link>
            <Link
