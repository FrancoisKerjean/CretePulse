  ...
  return (
    <main className="min-h-[60vh] flex items-center justify-center bg-surface px-4">
      <div className="text-center max-w-md">
        ...
        <p className="font-heading text-7xl font-bold text-sea/20 mb-2 font-data">404</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/beaches" className="px-6 py-3 bg-white text-sea border border-sea/20 rounded-full font-heading font-bold text-sm hover:bg-sea-faint transition-colors">
            Beaches
          </Link>
          <Link href="/events" className="px-6 py-3 bg-white text-terracotta border border-terracotta/20 rounded-full font-heading font-bold text-sm hover:bg-terracotta-faint transition-colors">
            Events
          </Link>
        </div>
      </div>
