...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-surface">
      ...
      {/* Hero - warm, Mediterranean, not tech */}
      <section className="relative overflow-hidden pt-16 pb-12 px-4" style={{
        background: "linear-gradient(170deg, #F7F4F0 0%, #FBF0EB 40%, #E8F1F5 100%)"
      }}>
