...
const CONTENT: Record<Locale, { title: string; intro: string; dataSection: { heading: string; text: string }; affiliation: string; closing: string; contact: { label: string; email: string } }> = {
  en: {
    title: "About CretePulse",
    intro: "Crete Pulse is a free, independent guide to the island of Crete. We aggregate live data (weather, sea conditions, fire alerts), local events, and practical information for residents and visitors.",
    dataSection: {
    ...
    affiliation: "Crete Pulse is not affiliated with any tourism agency, real estate company, government body, or commercial organization. We are independent and community-focused.",
    closing: "Built with love from Crete.",
    contact: {
      label: "Questions or feedback?",
      email: "hello@cretepulse.com",
    },
  },
  fr: {
    title: "À propos de CretePulse",
    intro: "Crete Pulse est un guide gratuit et indépendant de l'île de Crète. Nous agrégeons des données en direct (météo, conditions marines, alertes incendies), des événements locaux et des informations pratiques pour les résidents et les visiteurs.",
    dataSection: {
    ...
    affiliation: "Crete Pulse n'est affilié à aucune agence de tourisme, société immobilière, organisme gouvernemental ou organisation commerciale. Nous sommes indépendants et centrés sur la communauté.",
  ...
  de: {
    title: "Über CretePulse",
    intro: "Crete Pulse ist ein kostenloser, unabhängiger Führer durch die Insel Kreta. Wir aggregieren Live-Daten (Wetter, Meeresbedingungen, Feueralerts), lokale Veranstaltungen und praktische Informationen für Einwohner und Besucher.",
    dataSection: {
    ...
    affiliation: "Crete Pulse ist nicht mit Tourismusbehörden, Immobilienunternehmen, Behörden oder kommerziellen Organisationen verbunden. Wir sind unabhängig und gemeinschaftsorientiert.",
  ...
  el: {
    title: "Σχετικά με CretePulse",
    intro: "Το Crete Pulse είναι ένας δωρεάν και ανεξάρτητος οδηγός του νησιού της Κρήτης. Συγκεντρώνουμε ζωντανά δεδομένα (καιρός, θαλάσσιες συνθήκες, ειδοποιήσεις πυρκαγιών), τοπικές εκδηλώσεις και πρακτικές πληροφορίες για κατοίκους και επισκέπτες.",
    dataSection: {
    ...
    affiliation: "Το Crete Pulse δεν συνδέεται με κανένα τουριστικό γραφείο, κτηματομεσιτική εταιρεία, κρατική υπηρεσία ή εμπορική οργάνωση. Είμαστε ανεξάρτητοι και προσανατολισμένοι στην κοινότητα.",
