  ...
  tr: {
    ...
    how: [
      ...
      },
      {
        ...
        p: "Bölgede doğruladığımız tedarikçiler talebinizi alır ve e-posta ile tüm grubunuz için bir fiyatla — kişi başı değil — yanıt verir. 24 saat içinde yanıt alırsınız.",
      },
      {
...
export const CATEGORY_STRINGS: Record<string, Record<string, { h1: string; intro: string }>> = {
  ...
  hiking: {
    ...
    ru: {
      ...
      intro: "У Крита одна из самых густых сетей троп среди всех греческих островов — от прибрежных тропинок до Белых гор высотой свыше 2 000 м. Самый известный маршрут — ущелье Самария, но есть десятки других ущелий, участки европейского дальнего маршрута E4 и более тихие горные тропы, где редко встретишь других туристов. Местный гид знает, какие тропы открыты, какие требуют разрешений и каков рельеф на самом деле. Они рассчитывают свои маршруты для вашей группы — одиночные путешественники, семьи и опытные треккеры — у всех разные потребности.",
    },
    ja: {
      h1: "クレタ島のハイキングと自然",
      intro: "クレタ島はギリシャのすべての島の中で最も密なトレイルネットワークの一つを持っています — 海岸の小道から標高2,000m超の白山地まで。最も有名なルートはサマリア渓谷ですが、他にも数十の渓谷、ヨーロッパ長距離トレイルE4の区間、他の観光客にほぼ出会わないより静かな山道があります。地元のガイドはどの道が開いているか、許可が必要な道はどれか、そして実際の地形を把握しています。一人旅、家族連れ、経験豊富なトレッカー、それぞれに異なるニーズに合わせてグループ料金を提示します。",
    },
    ko: {
      h1: "크레타 하이킹 및 자연",
      intro: "크레타는 모든 그리스 섬 중 가장 밀도 높은 트레일 네트워크 중 하나를 보유하고 있습니다 — 해안 경로부터 2,000m 이상의 백산 지대까지. 가장 유명한 경로는 사마리아 협곡이지만 다른 협곡, 유럽 장거리 트레일 E4 구간, 다른 관광객을 만날 가능성이 낮은 더 조용한 산길도 수십 곳 있습니다. 현지 가이드는 어떤 길이 열려 있는지, 허가가 필요한 길은 어디인지, 그리고 지형이 실제로 어떤지 알고 있습니다. 혼자 여행하는 사람, 가족, 경험 많은 트레커 모두 다른 필요가 있으므로 그룹 가격을 제시합니다.",
    },
    zh: {
      h1: "克里特岛徒步与自然",
