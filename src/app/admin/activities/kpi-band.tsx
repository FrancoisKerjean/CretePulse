// Bandeau KPI (server component pur) : agregats 7 j / 30 j. Metrique non calculable
// (denominateur 0) -> affichee "n/d", jamais un ratio invente.
import type { CockpitKpis } from "@/lib/activity-monitoring";
  ...
  return (
    <div className="flex-1">
      ...
      <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-3">
        ...
        <Cell label="delai median 1er devis" v={k.medianFirstQuoteHours == null ? "n/d" : `${num(k.medianFirstQuoteHours)}h`} />
        <Cell label="taux de choix" v={pct(k.choiceRate)} />
        <Cell label="desist. prestataire" v={pct(k.partnerDeclineRate)} />
        <Cell label="decline client" v={pct(k.clientDeclineRate)} />
        <Cell label="effic. relance prestataire" v={pct(k.partnerRelanceEfficacy)} />
