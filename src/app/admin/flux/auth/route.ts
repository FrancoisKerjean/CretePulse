// Entrée du cockpit flux : /admin/flux/auth?key=<CAR_ADMIN_SECRET>
// Même secret + même cookie que /admin/car-rental (un seul opérateur : Kami),
// seule la destination du redirect diffère.
...
export async function GET(request: NextRequest) {
  ...
  const res = NextResponse.redirect(new URL("/admin/flux", request.url));
